    ...
    <div className="min-h-screen flex flex-col">
      ...
      <header className="sticky top-0 z-20 border-b border-white/5 glass">
        <div className="max-w-3xl mx-auto px-6 h-14 flex items-center gap-4">
          ...
          <p className="text-sm text-gray-400 truncate">{link.title || link.url}</p>
        </div>
      </header>
      ...
      <main className="max-w-3xl mx-auto w-full px-6 py-8 pb-32 flex-1">
        ...
        {notes ? (
          <div className="space-y-8">
            ...
            {flashcards.length > 0 && (
              <section>
                <SectionHeader icon="🃏" title="Flashcards" />
        ...
        <div className="fixed bottom-0 left-0 right-0 z-30 border-t border-white/5 glass px-6 py-3">
          <div className="max-w-3xl mx-auto flex items-center gap-4">
            <div className="shrink-0">
              <div className="w-8 h-8 rounded-lg bg-indigo-600/80 flex items-center justify-center text-xs">🎧</div>
            </div>
